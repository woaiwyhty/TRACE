...
def apache_prediction(encoder, data_path, device):
    ...
    dim_reduction(encodings=encodings, labels=apache_labels, save_path='./DONTCOMMITplots/HiRID_apache_classification', plot_name='e2e_first_encodings_clustered_TSNE', label_names=apache_names)
    dim_reduction(encodings=encodings, labels=apache_labels, save_path='./DONTCOMMITplots/HiRID_apache_classification', plot_name='e2e_first_encodings_clustered_PCA', label_names=apache_names, reduction_type='PCA')
    dim_reduction(encodings=encodings, labels=apache_labels, save_path='./DONTCOMMITplots/HiRID_apache_classification', plot_name='e2e_first_encodings_clustered_UMAP', label_names=apache_names, reduction_type='UMAP')
